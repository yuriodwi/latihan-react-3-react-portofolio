      ...
      <div className="md:flex md:justify-between mt-16 gap-32">
        ...
        >
          ...
          <p className="mt-5">
            ...
            provident deserunt, quam deleniti voluptatem expedita laboriosam
            delectus inventore esse ratione alias ipsam culpa eius nostrum. Iste
            nisi quidem odio sed!
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="mt-5">
            ...
            aperiam provident aut amet natus quae sequi optio, maiores eos
            voluptates.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="mt-5">
            ...
            ipsa cumque facilis maiores expedita vero adipisci laudantium
            voluptatem odio perferendis labore, optio sapiente esse. Sequi
            perferendis quae magnam earum laboriosam placeat eveniet!
          </p>
        </motion.div>
      </div>
    </section>
